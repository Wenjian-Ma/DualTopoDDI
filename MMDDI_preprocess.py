...
def save_data(data):
    ...
    filename = '/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/case/drug_data.pkl'
...
def load_drug_mol_data():
    ...
    data1 = pd.read_csv('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/AUC_FC/fold1.csv', delimiter=',')
    data2 = pd.read_csv('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/AUC_FC/fold2.csv', delimiter=',')
    data3 = pd.read_csv('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/AUC_FC/fold3.csv', delimiter=',')
    data4 = pd.read_csv('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/AUC_FC/fold4.csv', delimiter=',')
    data5 = pd.read_csv('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/AUC_FC/fold5.csv', delimiter=',')
    ...
    with open('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/AUC_FC/External.csv') as f:
    ...
    #
    # with open('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/MMDDI/DDInter.csv') as f:
    #     for id, line in enumerate(f):
    #         if id == 0:
    #             continue
    #         id1 = line.strip().split(',')[0]
    ...
    #         drug_smile_dict[id2] = smiles2
    # ##################################################################
    # with open('/media/ST-18T/Ma/DualTopoDDI/data/preprocessed/case/ddi_for_58.csv') as f:
    #     for id, line in enumerate(f):
    #         if id == 0:
    #             continue
    #
